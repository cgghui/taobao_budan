...
<body>
	...
	<div class="container-fluid content">
		...
		<div class="main">
            <div class="row">
            	<div class="col-lg-12">
            		<h3 class="page-header"><i class="fa fa-laptop"></i> 批量添加栏目</h3>
            		<ol class="breadcrumb">
                ...
                <div class="panel-body">
                    ...
                    <div class="theBody"><!--theBody start-->
                        <div class="filledForm" style="margin-top: 10px;"><!--filledForm start-->
                          <form method="post" class="addAdmin" method="<?php echo $this->createUrl('article/articleCatlogAddMore');?>">
                          <table border="0" cellspacing="0" cellpadding="0" style=" line-height:40px;">
                            <tr>
                              <td width="104">栏目名称:</td>
                              <td colspan="3"><input type="text" value="" name="name" style="width: 350px; height:25px; line-height:25px;" class="inputxt" datatype="*" nullmsg="请输入栏目名称！" errormsg="至少1个字符！" /></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td colspan="3"><div class="Validform_checktip">请输入栏目名称以逗号即","分割</div></td>
                            </tr>
                            <tr>
	...
	<!-- end: JavaScript-->
    <link rel="stylesheet" href="<?php echo ASSET_URL;?>default/css/validForm.css" type="text/css" media="all" />
