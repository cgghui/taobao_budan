            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <?php 
                        if(isset($cataName))
                        {
                            echo $this->renderPartial('_Dyform', array('model'=>$model,"class_arr"=>$class_arr,"optionStr"=>$optionStr));
                        }
                        else
                        {
                            echo $this->renderPartial('_Dyform', array('model'=>$model,"class_arr"=>$class_arr));
                        }
                     ?>
                </div><!--theBody end-->
                <div class="clear"></div>
