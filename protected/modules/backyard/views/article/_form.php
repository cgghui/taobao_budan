...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <tr>
		...
		<td>
            <?php
                echo '<select name="Article[cat_id]" id="Article_cat_id">';
                if(isset($optionStr))
                {
                    echo $optionStr;
                }
    ...
    <tr>
        ...
        <td colspan="2">
            <div id="J_imageView">
                <ul style="padding-bottom: 15px; padding-left: 0; margin-left: 0;">
                    <?php
	...
	<tr>
		...
		<td><?php echo $form->textField($model,'add_time',array('maxlength'=>10,"value"=>date("Y:m:d h:i:s",time()),'readonly'=>true)); ?></td>
		<td><?php echo $form->error($model,'add_time'); ?></td>
	</tr>
	...
	<tr>
		<td><?php echo $form->labelEx($model,'is_delete'); ?></td>
		<td>
            <select name="Shopgoods[is_delete]" id="Shopgoods_is_delete">
                <?php
                if($model->is_hot!="")
                {
                ?>
                <option value="<?php echo $model->is_delete;?>">
                <?php   
		...
		<td><?php echo $form->error($model,'is_delete'); ?></td>
	</tr>
