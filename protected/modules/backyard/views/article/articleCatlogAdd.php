...
<body>
	...
	<div class="container-fluid content">
		...
		<div class="main">
            <div class="row">
            	<div class="col-lg-12">
            		<h3 class="page-header"><i class="fa fa-laptop"></i> 添加栏目</h3>
            		<ol class="breadcrumb">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <span>
                        添加栏目　【<a href="<?php  echo $this->createUrl('article/articleCatlogAddMore');?>">批量添加栏目</a>】
                    </span>
                </div>
                <div class="panel-body">
                    ...
                    <div class="theBody"><!--theBody start-->
                        <div class="filledForm" style="margin-top: 10px;"><!--filledForm start-->
                          <form method="post" class="addAdmin" method="<?php echo $this->createUrl('article/articleCatlogAdd');?>">
                          <table border="0" cellspacing="0" cellpadding="0" style="width:500px; height:auto; color:#666; line-height:40px; font-size:12px;">
                              <td width="140">文档分类名称:</td>
                              <td width="175"><input type="text" value="" name="name" style="width: 150px; height:25px; line-height:25px;" class="inputxt" datatype="s1-100" nullmsg="请输入栏目名称！" errormsg="至少1个字符！" /></td>
                              <td width="201"><div class="Validform_checktip" style="width:150px;">请输入栏目名称</div></td>
                            </tr>
                            <tr>
                              <td width="104">选择文档类型:</td>
                              <td width="175"><select name="type"><option value="1">文章列表</option><option value="0">单页</option></select></td>
                              <td width="201"></td>
                            </tr>
                            <tr>
                              <td><div align="center"></div></td>
                              <td><button type="submit" class="btn btn-sm btn-success" border="0" id="reg_submit"><i class="fa fa-dot-circle-o"></i>&nbsp;确认添加</button></td>
                              <td>&nbsp;</td>
                            </tr>
                          </table>
                          </form>
	...
	<!-- end: JavaScript-->
    <script type="text/javascript" src="<?php echo JS_URL;?>Validform_v5.3.1.js"></script>
    <script>
		$(function(){
			$(".addAdmin").Validform({
				tiptype:2,
