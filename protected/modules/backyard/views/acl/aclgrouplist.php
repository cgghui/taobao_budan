...
<body>
	...
	<div class="container-fluid content">
		...
		<div class="main">
            <div class="row">
            	<div class="col-lg-12">
            		<h3 class="page-header"><i class="fa fa-laptop"></i> 用户组列表</h3>
            		<ol class="breadcrumb">
            ...
            <div class="panel panel-default"><!--theBody start-->
                ...
                <div class="panel-body">
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                <th width="26%">用户组ID</th>
                                <th width="45%"><div align="center">用户组名称</div></th>
                                <th width="16%">&nbsp;</th>
                        ...
                        <td>&nbsp;</td>
                        <td><div align="center"><a href="<?php echo $this->createUrl('acl/aclgroupeditpower',array("groupid"=>$item['id']));?>" style="color:green; font-weight: normal;"><img src="<?php echo BACKYARD_IMG_URL;?>icons/pencil.png" title="点击修改权限"/></a>　<a onclick='if(confirm("您确定删除吗？删除后将无法恢复")) return ture; else return false;' href="#"><img src="<?php echo BACKYARD_IMG_URL;?>icons/cross.png" title="删除该用户组" /></a></div></td>
                        </tr>
                        <?php
                            }
                        ?>
