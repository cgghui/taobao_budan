...
<body>
	...
	<div class="container-fluid content">
		...
		<div class="main">
            <div class="row">
            	<div class="col-lg-12">
            		<h3 class="page-header"><i class="fa fa-laptop"></i> 添加管理员</h3>
            		<ol class="breadcrumb">
                ...
                <div class="panel-body">
                    ...
                    <div class="theBody"><!--theBody start-->
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    <th width="26%"><div align="center">用户名</div></th>
                                    <th width="32%"><div align="center">管理员密码</div></th>
                                    <th width="29%"><div align="center">选择用户组</div></th>
                                    <th width="13%"><div align="center">操作</div></th>
                                </tr>
                            </thead>
                            <form onsubmit="return checktheForm()" method="post" action="<?php echo $this->createUrl('acl/manageradd');?>">
                                <tbody>
                                    <tr style="color:#666;">
                                        <td><div align="center">
                                        ...
                                        <td>
                                            <div align="center">
                                              <select name="groupid" style="padding: 0 10px;">
                                                <?php
                                        ...
                                        <td><div align="center">
                                          <button type="submit" class="btn btn-sm btn-success" border="0" id="reg_submit"><i class="fa fa-dot-circle-o"></i>&nbsp;确认添加</button>
                                        </div></td>
                                    </tr>
                                </tbody>
                            </form>
