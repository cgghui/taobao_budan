                    ...
                    <div class="theBody"><!--theBody start-->
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    <th>用户名</th>
                                    <th><div align="center">输入新密码</div></th>
                                    <th>&nbsp;</th>
                                    <th><div align="center">操作</div></th>
                                </tr>
                            </thead>
                            <form method="post" action="<?php echo $this->createUrl('acl/managerinfochange');?>">
                                <tbody>
                                    <tr style="color:#666;">
                                        <td><a href="#"><?php echo $managerinfo->username;?></a></td>
                                        <td>
                                            <div align="center">
                                        ...
                                        <td>&nbsp;</td>
                                        <td><div align="center"><input type="submit" value="确认修改" /></div></td>
                                    </tr>
                                </tbody>
                            </form>
                        </table>
