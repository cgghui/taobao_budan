...
<body>
	...
	<div class="container-fluid content">
		...
		<div class="main">
            <div class="row">
            	<div class="col-lg-12">
            		<h3 class="page-header"><i class="fa fa-laptop"></i> 财务报表</h3>
            		<ol class="breadcrumb">
            			<li><i class="fa fa-home"></i><a href="<?php  echo $this->createUrl('default/index');?>">首页</a></li>
            			<li><i class="fa fa-laptop"></i>财务报表</li>						  	
            		</ol>
            	</div>
            </div>
            <div class="panel panel-default"><!--theBody start-->
                <div class="panel-heading">
					...
					<?php if($_GET['type']==1){ ?>
                    <span>财务报表—现金|<a href="<?php  echo $this->createUrl('moneyman/finance',array('type'=>2));?>">金币</a></span>
					<?php }else{ ?>
					<span>财务报表—<a href="<?php  echo $this->createUrl('moneyman/finance',array('type'=>1));?>">现金</a>|金币</span>
					<?php } ?>
                    ...
                    <table class="table table-hover">
                        ...
                        ?>
                            <tr>
                                ...
                                <td><div align="center"><?php if($item->catalog==7 || $item->catalog==8) echo '-'; if($item->catalog ==7) {echo $item->MinLi;}else{echo $item->number;}?></div></td>
                                <td><div align="center"><?php echo $array[$item->catalog];?></div></td>
                                <td><div align="center"><?php echo date("Y-m-d H:i:s",$item->time);?></div></td>
								<td><div align="center"><?php echo $item->yue;?></div></td>
                            </tr>
                        <?php
                            }
                        ?>
