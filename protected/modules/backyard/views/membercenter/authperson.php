                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th><div align="center">生活照</div></th>
                        ...
                        <tbody>
                            ...
                            <tr style="color:#666;">
                                ...
                                <td>
                                    <div align="center">
                                        <?php
                                            if($item->status==0 && $item->username)
                                            {
                                                echo '<a href="'.$this->createUrl('membercenter/authperson',array('authid'=>$item->id,'uid'=>$item->uid)).'" style="color:red;" title="点击确认视频认证通过，即审核完成">视频认证通过</a>';
                                            }else if($item->status==0 && $item->username==false)
                                            {
                                                echo '<a href="'.$this->createUrl('membercenter/authperson',array('authid'=>$item->id,'uid'=>$item->uid)).'" style="color:red;" title="点击确认视频认证通过，即审核完成">淘内幕认证通过</a>';
                                            }
                                            else
                                            {
                                                echo "<font style='font-weight:bold; color:green;'>认证通过</font><br/><a href='".$this->createUrl('membercenter/authperson',array('authid'=>$item->id,'nopass'=>"DOIT",'uid'=>$item->uid))."' title='认证不通过'>删除认证</a>";
                                            }
                                        ?>
                                    </div>
                                </td>
