...
<body>
	...
	<div class="container-fluid content">
		...
		<div class="main">
            <div class="row">
            	<div class="col-lg-12">
            		<h3 class="page-header"><i class="fa fa-laptop"></i> 掌柜号管理</h3>
            		<ol class="breadcrumb">
            ...
            <form method="post" action="<?php echo $this->createUrl("membercenter/sellerlist")?>">
                <input type="text" name="keyword" placeholder="请输入掌柜号" style="text-indent: 5px; color: #666; font-size:14px; width:260px;" />　<button type="submit" class="btn btn-sm btn-success" border="0" id="reg_submit"><i class="fa fa-dot-circle-o"></i>&nbsp;搜索</button>
            </form>
            <br />
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th><div align="center">掌柜号</div></th>
                                <th><div align="center">所属平台</div></th>
                        ...
                        <tbody>
                            ...
                            <tr style="color:#666;">
                                ...
                                <td><div align="center"><?php echo @$usermsg->Username;?></div></td>
                                <td><div align="center"><?php echo @$usermsg->Phon;?></div></td>
                                <td><div align="center" style=" color:green; font-weight:bold;"><?php echo @$item->wangwang;?></div></td>
                                <td><div align="center"><?php echo @$item->platform==1?"淘宝":"京东";?></div></td>
                                <td><div align="center"><?php echo @$item->authStoreStatus==1?"<span style='color:green;'>通过</span>":"<span style='color:red;'>未通过</span> <a href='".$this->createUrl('membercenter/letSellerPass',array('authid'=>$item->id))."'>手动通过</a>";?></div></td>
                                <td><div align="center"><a onclick="if(confirm('您确定要删除吗？请确保该买号没有接过任务!删除后将无法恢复！')) return true; else return false;" href="<?php echo $this->createUrl('membercenter/wangwangdel',array('id'=>$item->id));?>">删除</a></div></td>
                            </tr>
                            <?php
                                }
                            ?>
