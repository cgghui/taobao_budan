...
<div id="content">
  ...
  <div class="cle"></div>
  <div class="gou">
    <p><b>提示：</b>请不要使用相同的商品地址，最多只能添加6个不同的商品，每天发布的购物车任务数量请不要太多</p>
    <p class="kg">根据自身情况添加2-6个商品，不一定要全部都加满6个商品，购物车请在其中一个商品价格中包含运费</p>
  </div>
      ...
      <div class="left_xf fixed" style="top: 200px;">
        <div class="left_xf_nav">
          <ul>
            ...
            <li><a href="javascript:void(0)">筛选接手</a></li>
            <li><a href="javascript:void(0)">快递空包</a></li>
          </ul>
        </div>
        <div class="xf_fban">
              ...
              <div class="drw">
                ...
                <div class="product_content2">
                  ...
                  <ul class="pc1">
                    ...
                    <li class="s38" title="使用您保存的模板快速读取相关数据">使用模板：</li>
                    <li class="s36 right">
                  ...
                  <ul class="pc1" id="ppuul">
                    ...
                    <li class="s34 right">
                      <select name="ddlOKDay" id="ddlOKDay" class="ui-select" style="display: none;">
                        ...
                        <option value="1">24小时(基本金币×1.5+0)</option>
                      ...
                      <div class="select-main">
                        ...
                        <div class="select-block" style="display: none;">
                          <ul class="select-list" style="height: 250px; overflow: auto;">
                            ...
                            <li class="select-items">24小时(基本金币×1.5+0)</li>
                            <li class="select-items">48小时(基本金币×1.5+1)</li>
                            <li class="select-items">72小时(基本金币×1.5+2)</li>
                            <li class="select-items">96小时(基本金币×1.5+3)</li>
                            <li class="select-items">120小时(基本金币×1.5+4)</li>
                            <li class="select-items">144小时(基本金币×1.5+5)</li>
                            <li class="select-items">168小时(基本金币×1.5+6)</li>
                          </ul>
                        </div>
                      </div>
                    </li>
                ...
                <div class="ligoods">
                  <div class="product_content2  ">
                    <ul class="pc1">
                      <li class="s35" title="输入您想提升销量的商品链接"><img src="<?php echo VERSION2;?>taskcss/c12.jpg" alt="">商品<span class="product_index">1</span>链接地址：</li>
                      <li class="s36">
                        <input type="text" class="pc11 inputp s36_ts" name="shopAll[1][txturl]" id="txtGoodsUrl" placeholder="http://">
                      </li>
                      <li class="h37" title="请输入打折后的价格，保持平台价格与淘宝价格一致">商品价格：(包含邮费)
                        <input type="text" id="txtPrice" name="shopAll[1][txtprice]" class="inputp" style="margin-left:5px;">
                      </li>
                      <li class="h38" title="您的淘宝商品价格不等于任务价格时，请勾选！改价不要超过商品价格的50%，支付宝使用率低于50%会被淘宝视为信用炒作处理。">改价：
                        <input type="checkbox" name="cbxIsGJ" class="h39">
                      </li>
                      <li class="h38" title="取消商品价格限制" style="display:none">打折：
                        <input type="checkbox" name="shopAll[1][chssp]" class="h39">
                      </li>
                  ...
                  <div class="pd" style="padding-top:20px;">
                    <ul class="pdul">
                      <li>
                        <div id="a11" class="nulldiv" title="规定好评内容。如：衣服质量很好，穿着舒适"></div>
                        <input type="checkbox" value="1" show="1" name="shopAll[1][cbhp]">
                      </li>
                      <li class="pdlli12" style="margin-left:4px;">
                        <input type="text" class="inputp" style="width:617px;margin-left:26px" name="shopAll[1][txthptext]" placeholder="您可以规定接手方在淘宝交易好评时填写规定的内容">
                        （<font class="pdfo">0.3</font>个金币） </li>
                    </ul>
                  </div>
                </div>
                <div class="ligoods">
                  <div class="product_content2  ">
                    <ul class="pc1">
                      <li class="s35" title="输入您想提升销量的商品链接" name="url"><img src="<?php echo VERSION2;?>taskcss/c12.jpg" alt="">商品2链接地址：</li>
                      <li class="s36">
                        <input type="text" class="pc11 inputp s36_ts" name="shopAll[2][txturl]" id="shopallurl2" placeholder="http://">
                      </li>
                      <li class="h37" title="请输入打折后的价格，保持平台价格与淘宝价格一致">商品价格：
                        <input type="text" id="shopallprice2" name="shopAll[2][txtprice]" class="inputp txtPrice" style="margin-left:5px;width:40px;">
                      </li>
                      <li class="h38" title="商品价格不等于任务商品担保价格时，请勾选！改价不要超过商品价格的50%，支付宝使用率低于50%既被淘宝视为信用炒作处理。"> 
                        <!--         改价：<input type="checkbox" class="h39"/> --> 
                      </li>
                      <li class="h38" title="取消商品价格限制">打折：
                        <input type="checkbox" value="1" name="shopAll[2][chssp]" class="h39">
                      </li>
                      <li>
                        <div class="ex" style="line-height:23px;padding:0 15px;"> <a href="javascript:void(0)" class="del" name="delli" value="2" title="删除" style="display: none;"></a> <a href="javascript:void(0)" name="addli" style="display: inline-block;color:#ff9118;">+添加商品</a> </div>
                      </li>
                    </ul>
                  </div>
                  <div class="pd" style="padding-top:20px;">
                    <ul class="pdul">
                      ...
                      <li class="pdlli12" style="margin-left:4px;">
                        <input type="text" class="inputp" style="width:617px;margin-left:26px" name="shopAll[2][txthptext]" placeholder="您可以规定接手方在淘宝交易好评时填写规定的内容">
                      </li>
                    </ul>
                  </div>
                </div>
              </div>
              <!--  <div id='addproduct' ><a href="javascript:void(0);">+添加商品</a></div> --> 
      ...
      <div id="server" class="span6" data-step="3" data-intro="选择您想要的增值服务，这样能增加安全性">
        ...
        <div class="pd">
          <ul class="pdul" style="margin-top:15px;">
            ...
            <li class="pdli"><span>支付<font class="pdfo">1.0</font>个金币</span></li>
            <li>
              <div id="a2" class="nulldiv" title="收藏商家发布的商品"></div>
              <input type="checkbox" name="shopcoller" id="aa2">
            </li>
            <li class="pdli"><span>支付<font class="pdfo">0.5</font>个金币</span></li>
            <li>
              <div id="a3" class="nulldiv" title="要求接手使用手机付款"></div>
              <input type="checkbox" name="isMobile" id="aa3">
            </li>
            <li class="pdli"><span>支付<font class="pdfo">2.0</font>个金币</span></li>
          </ul>
          <ul class="pdul">
            <li>
          ...
          <ul class="pdul" style="display:none;">
            ...
            <li class="pdli"><span>每张支付<font class="pdfo">0.5</font>个金币</span></li>
            <li class="pdli">
          ...
          <ul class="pdul">
            ...
            <li class="pdli11">
              ...
              停1分钟<span class="f12"> （<font class="pdfo">0.1</font>个金币）</span></li>
            <li class="pdli11">
              <input type="radio" name="stopTime" value="2">
              停2分钟<span class="f12"> （<font class="pdfo">0.3</font>个金币）</span></li>
            <li class="pdli11">
              <input type="radio" name="stopTime" value="3">
              停3分钟<span class="f12"> （<font class="pdfo">0.5</font>个金币）</span></li>
          </ul>
          <ul class="pdul" style="display:none;">
            <li>
              <div id="a11" class="nulldiv" title="规定好评内容。如：衣服质量很好，穿着舒适"></div>
            ...
            <li class="pdlli12">
              ...
              支付<font class="pdfo">0.5</font>个金币</li>
          </ul>
          <ul class="pdul">
            <li>
      ...
      <div id="screen" data-step="4" data-intro="筛选出您想要的接手（接手人）">
        ...
        <div class="scmain">
          <ul class="pdul">
            ...
            <li class="h32"><span>支付<font class="pdfo">2.0</font>个金币</span></li>
          </ul>
          <ul class="pdul">
            <li>
            ...
            <li class="pdli11">
              ...
              1天接1个<span class="f12"> （<font class="pdfo">0.5</font>个金币）</span></li>
            <li class="pdli11">
              <input type="radio" name="fmaxmc" value="2">
              1天接2个<span class="f12"> （<font class="pdfo">0.2</font>个金币）</span></li>
            <li class="pdli11">
              <input type="radio" name="fmaxmc" value="3">
              1周接1个<span class="f12"> （<font class="pdfo">1.0</font>个金币）</span></li>
          </ul>
          <ul class="pdul">
            <li>
            ...
            <li class="scli1" title="按住Shifl键加单击选项，可多选！">
              ...
              多选省份<span class="f12">(支付<font class="pdfo">2.0</font>个金币)</span></li>
          </ul>
          <ul class="pdul">
            <li>
            ...
            <li class="h34">
              <select name="BuyerJifen" id="BuyerJifen" class="ui-select" placeholder="请选择模板" style="display: none;">
                <option value="1">一心及以上  （支付 0.5 金币）</option>
                <option value="2">二心及以上  （支付 1.0 金币）</option>
                <option value="3">三心及以上  （支付 2.0 金币）</option>
                <option value="4">四心及以上  （支付 3.0 金币）</option>
                <option value="5">五心及以上  （支付 4.0 金币）</option>
                <option value="6">一钻及以上  （支付 5.0 金币）</option>
                <option value="7">二钻及以上  （支付 6.0 金币）</option>
                <option value="8">三钻及以上  （支付 7.0 金币）</option>
                <option value="9">四钻及以上  （支付 8.0 金币）</option>
                <option value="10">五钻及以上  （支付 9.0 金币）</option>
              </select>
              <div class="select-main">
                <div class="select-arrow"></div>
                <div class="select-set">一心及以上  （支付 0.5 金币）</div>
                <div class="select-block" style="display: none;">
                  <ul class="select-list" style="height: 250px; overflow: auto;">
                    <li class="select-items active">一心及以上  （支付 0.5 金币）</li>
                    <li class="select-items">二心及以上  （支付 1.0 金币）</li>
                    <li class="select-items">三心及以上  （支付 2.0 金币）</li>
                    <li class="select-items">四心及以上  （支付 3.0 金币）</li>
                    <li class="select-items">五心及以上  （支付 4.0 金币）</li>
                    <li class="select-items">一钻及以上  （支付 5.0 金币）</li>
                    <li class="select-items">二钻及以上  （支付 6.0 金币）</li>
                    <li class="select-items">三钻及以上  （支付 7.0 金币）</li>
                    <li class="select-items">四钻及以上  （支付 8.0 金币）</li>
                    <li class="select-items">五钻及以上  （支付 9.0 金币）</li>
                  </ul>
                </div>
              </div>
            </li>
          ...
          <div class="nyd">
            <ul class="pdul_1">
              ...
              <li class="h99">
                ...
                100</li>
              <li class="s32"><span>支付<font class="pdfo">0.5</font>个金币</span></li>
            </ul>
            <ul class="pdul_1">
      ...
      <div id="express" class="div" data-step="5" data-intro="根据您手头的单号资源进行选择，可搜索“空包网”自行购买。">
        ...
        <div class="exmain">
          ...
          <ul class="pc1">
            ...
            <li class="s33"><span>支付<font class="pdfo">0.5</font>个金币</span></li>
          </ul>
          <div class="address1">
