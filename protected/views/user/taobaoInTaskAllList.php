    ...
    <div class="dtrw"><!--大厅任务-->
        <div class="dtrwCen">
            <div class="dtrwCen_t">
                <div class="rwso">
                    <form action="<?php echo $this->createUrl('user/taobaoInTaskAllList');?>" method="post">
            ...
            <li class="taskItem">
                ...
                <div class="allRw_pro">
                    ...
                    <?php
                        ...
                        if($item->status==4){
                    ?>
                        <a href="javascript:;" class="qcrw waitBuyerHP" lang="<?php echo $item->pinimage?1:0;?>" alt="<?php echo $item->id;?>" style="width: auto; padding:0 8px; cursor: pointer;">
                            <?php
