          ...
          <ul class="pmm">
            ...
            <li style="display:block;" class="lili">
              ...
              <div class="drw">
                ...
                <div class="pt"> <span class="h40"> <img class="h41" src="<?php echo VERSION2;?>taskcss/blue.png" alt="">商品信息： </span></div>
                  ...
                  <ul class="pc1">
                    ...
                    <li>
                        ...
                        <select id="task_type" name="task_type" class="ui-select zhsr">
                            ...
                            <option value="1" <?php if(@$teminfo && @$teminfo->task_type==1) echo "selected='selected'"?>>实物任务</option>
                  ...
                  <ul class="pc1" id="ppuul">
                    ...
                    <li class="s34">
                      ...
                      <select name="ddlOKDay" id="ddlOKDay" class="ui-select zhsr">
                        ...
                        <option value="0" <?php if(@$teminfo && @$teminfo->ddlOKDay==0) echo "selected='selected'"?>>马上好评（虚拟任务）</option>

                        <option value="4" <?php if(@$teminfo && @$teminfo->ddlOKDay==4) echo "selected='selected'"?>>24小时(金币+1)</option>

                        <option value="4" <?php if(@$teminfo && @$teminfo->ddlOKDay==4) echo "selected='selected'"?>>48小时(金币+1)</option>

                        <option value="4" <?php if(@$teminfo && @$teminfo->ddlOKDay==4) echo "selected='selected'"?>>72小时(金币+1)</option>

                        <option value="4" <?php if(@$teminfo && @$teminfo->ddlOKDay==4) echo "selected='selected'"?>>96小时(金币+1)</option>

                        <option value="5" <?php if(@$teminfo && @$teminfo->ddlOKDay==5) echo "selected='selected'"?>>120小时(金币+2)</option>

                        <option value="5" <?php if(@$teminfo && @$teminfo->ddlOKDay==5) echo "selected='selected'"?>>144小时(金币+2)</option>

                        <option value="6" <?php if(@$teminfo && @$teminfo->ddlOKDay==6) echo "selected='selected'"?>>168小时(金币+3)</option>
                    ...
                    <li class="s37" title="与商品价格、收货时长相关">基本金币：
                      ...
                      <input type="text" id="txtMinMPrice" readonly="" style="background:#F0F0F0; padding:0; text-align:center; padding:0 5px;" name="txtMinMPrice" class="inputp" value="<?php
...

                       {
                            ...
                            if(@$teminfo->txtPrice>10 && @$teminfo->txtPrice<51)//价格11-50元

                                $needMinLi=1.6;

                            if(@$teminfo->txtPrice>50 && @$teminfo->txtPrice<201)//价格51-200元
      ...
      <div id="screen" data-step="4" data-intro="筛选出您想要的接手（接手人）">
        ...
        <div class="scmain">
          ...
          <ul class="pdul">
            ...
            <li class="scli2">此等级以上可接任务<span>（支付<font class="pdfo">0.1 - 9.0</font>个金币）</span></li>
...
<script>
...

    {
...

        {
            ...
            if(txtPrice>0 && txtPrice<11)//价格1-80元

                MinLi=1.2

            if(txtPrice>10 && txtPrice<51)//价格81-150元

                MinLi=1.6

            if(txtPrice>50 && txtPrice<201)//价格151-200元
...
$(function(){
    ...
    $("#platform").change(function(){
...

        {
...

            {
                ...
                $("#payWay").html('<option value="1">威客垫付</option><option value="2">远程代付</option>');
    ...
    $("#ddlTemplate").change(function(){
...

        {
            ...
            location.href='/user/taskPublishPT/templete/'+$(this).val()+'.html';
