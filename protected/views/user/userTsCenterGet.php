    <!--申诉-->
  	<div class="d_shensu">
    	<div class="d_sl clearfix">
        	<p class="d_slp">您共收到<span class="d_slspan"><?php echo $total;?></span>次投诉</p>
        </div>
        <ul class="d_faqi clearfix">
        	<li onclick="location.href='<?php echo $this->createUrl('user/userTsCenter');?>'">我发起的申诉</li>
            <li class="d_shensu" onclick="location.href='<?php echo $this->createUrl('user/userTsCenterGet');?>'">我收到的申诉</li>
        </ul>
            ...
            <table>
                ...
                <?php
                    foreach($proInfo as $item){
                        ...
                        $userInfo=User::model()->findByPk($item->douid);
                ?>
                <tr class="d_xinxi_ul ulItem" style="border: none; font-size:14px; border-bottom: 1px dashed #99C1F5;">
                    ...
                    <td class="d_xxli2"><span style="color:red;"><?php echo $userInfo->Username;?></span></td>
