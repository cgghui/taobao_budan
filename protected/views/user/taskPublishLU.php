...
<div id="content">
  ...
  <div class="cle"></div>
    ...
    <div id="body_main" class="">
      ...
      <div class="left_xf fixed" style="top: 200px;">
        ...
        <div class="left_xf_nav">
          ...
          <ul>
            ...
            <li lang="screen"><a href="javascript:void(0)" class="">附加要求</a></li>
          ...
          <ul class="pmm">
            ...
            <li style="display:block;" class="lili">
              ...
              <div class="drw">
                ...
                <div class="pt"> <span class="h40"> <img class="h41" src="<?php echo VERSION2;?>taskcss/blue.png" alt="">商品信息： </span> <span class="h40" style="margin-left: 25px;"><a href="http://www.milioo.com/article/sell/122Q02015.html" target="_blank" style="color: red;font-size: 15px;"></a></span> </div>
                ...
                <div class="product_content1">
                  ...
                  <ul class="dowebok">
                    ...
                    <li class="s40 searchway" title="要求接手搜索直通车广告进店">
					  ...
					  <li class="pdli"><span>支付<font class="pdfo"><?php echo $appendMinLi->value;?></font>个金币</span></li>
                  ...
                  <ul class="pc1" id="ppuul">
                    ...
                    <li class="s34">
                      ...
                      <select name="ddlOKDay"  id="ddlOKDay" class="ui-select zhsr">
                        ...
                        <option value="4">24小时(金币+1)</option>

                        <option value="4">48小时(金币+1)</option>

                        <option value="4">72小时(金币+1)</option>

                        <option value="4">96小时(金币+1)</option>

                        <option value="5">120小时(金币+2)</option>

                        <option value="5">144小时(金币+2)</option>

                        <option value="6">168小时(金币+3)</option>
                ...
                <div class="product_content2">
                  ...
                  <ul class="pc1">
                    ...
                    <li class="s37" title="与商品价格、收货时长相关">基本金币：
                      ...
                      <textarea name="txtMinMPrice" readonly="readonly" class="inputp" id="txtMinMPrice" style="background:#F0F0F0; padding:0; text-align:center; padding:0 5px;"><?php

                       if(@$teminfo && @$teminfo->txtPrice)

                       {

                            if(@$teminfo->txtPrice>0 && @$teminfo->txtPrice<11)//价格1-10元

                                $needMinLi=1.2;

                            if(@$teminfo->txtPrice>10 && @$teminfo->txtPrice<51)//价格11-51元

                                $needMinLi=1.6;

                            if(@$teminfo->txtPrice>50 && @$teminfo->txtPrice<201)//价格51-201元

                                $needMinLi=2;

                            if(@$teminfo->txtPrice>200 && @$teminfo->txtPrice<351)//价格201-351元

                                $needMinLi=2.3;

                            if(@$teminfo->txtPrice>350 && @$teminfo->txtPrice<501)//价格351-501元
				...
				<div class="product_content2">
                  ...
                  <ul class="pc1" id="ppuul">
                    ...
                    <li class="s35" title="任务有效期。ps：超过该有效期，如果没有人接手，任务将不会出现在任务大厅。">

                        <img src="<?php echo VERSION2;?>taskcss/c12.jpg" alt="">任务有效期：</li>

                    <li class="s36 s36_ts">

                      <input type="text" class="pc11 inputp inputxt" name="expiretime" id="expiretime" value="<?php if(@$teminfo && @$teminfo->expiretime) {echo @$teminfo->expiretime;}else{ echo 0;}?>" />小时（0或不填为长期有效）

                    </li>

                    <li class="s35" title="是否可改价">

                       改价：</li>

                   <li class="s36 s36_ts" title="是否改价">

                      <input type="checkbox" name="gaijia" value="1"><span>支付<font class="pdfo"><?php echo $gaijiaMinLi->value;?></font>个金币</span>
      ...
      <div id="server" class="span6" data-step="3" data-intro="选择您想要的基本要求，这样能增加安全性">

        <div class="pt"> <span class="h40"> <img class="h41" src="<?php echo VERSION2;?>taskcss/blue.png" alt="">基本要求： </span> </div>
      ...
      <div id="screen" data-step="4" data-intro="筛选出您想要的接手（接手人）">
        ...
        <div class="pt"> <span class="h40"> <img class="h41" src="<?php echo VERSION2;?>taskcss/blue.png" alt="">附加要求： </span> </div>
        ...
        <div class="scmain">
          ...
          <ul class="pdul">
            ...
            <li class="pdli11">
			 ...
			 <li class="pdli11">
              ...
              1月接1个<span class="f12"> （<font class="pdfo"><?php echo $xzjstwoMinLi->value;?></font>个金币）</span></li>
          ...
          <ul class="pdul">
            ...
            <li class="scli2">此等级以上可接任务<span>（支付<font class="pdfo">0.1 - 9</font>个金币）</span></li>
...
<script>
...

    {
...

        {
            ...
            if(txtPrice>0 && txtPrice<11)//价格1-10元

                MinLi=1.2

            if(txtPrice>10 && txtPrice<51)//价格11-50元

                MinLi=1.6

            if(txtPrice>50 && txtPrice<201)//价格51-200元
