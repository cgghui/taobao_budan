    ...
    <div class="dtrw"><!--大厅任务-->
        <div class="dtrwCen">
            <div class="dtrwCen_t">
                <div class="rwso">
                    <form action="<?php echo $this->createUrl('user/taobaoOutTaskStop');?>" method="post">
                        ...
                        <div class="allRw_prosLis">
                            ...
                            <div class="allRw_proLink">
                                ...
                                <?php
                                    if($item->isCompare){
                                ?>
                                <a class="bueryImg" alt="<?php echo $item->taskerOtheroneImg!=""?$item->taskerOtheroneImg:"";?>" title="接任务者需要根据任务提示上传货比<?php echo $item->contrast;?>家截图">
                                ...
                                <?php
                                    if($item->shopBrGoods){
                                ?>
                                <a class="bueryImg" alt="<?php echo $item->taskerOtheroneImg!=""?$item->taskerOtheroneImg:"";?>" title="接任务者需要根据任务提示浏览店内其他<?php echo $item->lgoods;?>件商品并截图">
                                    浏览商品
                                </a>
                                <?php }?>
                                <?php
