        ...
        <div class="d_qie2">
            <div class="d_menu">
            	<ul>
                	<li onclick="window.location.href='<?php echo $this->createUrl('user/userCashToBank');?>'">
                    	银行卡提现
                    </li>
                    <li class="now" onclick="window.location.href='<?php echo $this->createUrl('user/userTxList');?>'">
                    	提现记录
                    </li>
                </ul>
            </div>
