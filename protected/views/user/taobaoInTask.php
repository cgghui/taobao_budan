            ...
            <li class="taskItem">
                ...
                <div class="allRw_pro">
                    ...
                    ?>
                        ...
                        <a href="javascript:;" <?php if($lasttime>=0){ ?> class="qcrw waitBuyerHP" style="width: auto; padding:0 8px; cursor: pointer;" <?php }else{ ?> class="qcrw" style="width: auto; padding:0 8px; cursor: pointer;background:#FFC1C1" <?php } ?> lang="<?php echo $item->pinimage?1:0;?>" alt="<?php echo $item->id;?>">
                ...
                <div class="takerInfo"><!--taskFunMan start-->
                    ...
                    <span>商家信息：</span><?php echo $usermsg->Username;?>　<img src="<?php echo VERSION2?>img/wang.jpg" width="20" style="position: relative; top:5px;" />&nbsp;采用买号：<?php echo $item->taskerWangwang;?>　

					<?php if($item->taskCatalog == 0) { ?><span class="showaddr" alt="<?php echo $item->txtGoodsUrl;?>" style="padding-left:0;padding-right:10px;cursor:pointer;color:blue">复制宝贝地址</span> <?php } ?>

					联系对方：&nbsp;<a title="点击添加对方为好友" target=blank href=http://wpa.qq.com/msgrd?V=3&uin=<?php echo $usermsg->QQToken;?>&Site=点击添加好友&Menu=yes><img border="0" SRC=http://wpa.qq.com/pa?p=1:<?php echo $usermsg->QQToken;?>:4 alt="点击这里给我发消息" style="position: relative; top:2px; left:-3px" /></a>
...

        {
            ...
            $(".settime").each(function(i){
...

                {
                    ...
                    $(this).html("<span style='line-height:30px; color:#666;'>"+actionName+"剩余时间：<font style='color:red; font-weight:bold;'>"+day+"天"+hour+"小时"+minite+"分"+second+"秒</font></span>");
    ...
    <script>
        ...
        $(function(){
            ...
            $(".waitBuyerHP").click(function(){
...

                {
                   ...
                   $.ajax({
            			...
            			data:{"taskid":taskid,"url3":"notNeed"},
            ...
            $(".showaddr").click(function(){
				...
				baobeidizhi="宝贝地址为："+$(this).attr("alt");
