...
/**
 * This is the model class for table "{{_shopgoods}}".
 *
 * The followings are the available columns in table '{{_shopgoods}}':
...
class Shopgoods extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('goods_name','required',"message"=>"商品名称必填"),
                        array('shop_price','required',"message"=>"本店售价必填"),
                        array('cat_id','required',"message"=>"分类必选，如果没有分类请先添加分类"),
